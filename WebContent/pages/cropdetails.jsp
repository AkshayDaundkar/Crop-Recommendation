...
<div class="container-scroller">
      ...
      <div class="content-wrapper d-flex align-items-center auth register-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <h2 class="text-center mb-4">Enter Crop Details</h2>
            <div class="auto-form-wrapper">
              <form name="myform" id="myform" action="javascript:fnSubmit();" method="post">
                <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Select Crop</label>
                          <div class="col-sm-9">
                           <select name="name" class="form-control">
                    <%=ConnectionManager.getCombo("SELECT dataid as ke, name as val FROM cropdataset where datatype like 'crop'")%>
                  </select>
                          </div>
                        </div>
                     <div class="form-group row">
  ...
  function fnSubmit(){	
		...
		$.post("<%=request.getContextPath()%>/tiles/ajax.jsp?methodId=addNewCrop",
				str,
				function(data) {
			data=$.trim(data);  
		if (data==1) {
