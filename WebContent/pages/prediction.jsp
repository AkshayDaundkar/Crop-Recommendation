							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<select name="state" class="form-control">
										<%=ConnectionManager
					.getCombo("SELECT dataid as ke, name as val FROM cropdataset where name like 'Maharashtra'")%>
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<select name="dist" class="form-control">
										<%=ConnectionManager
					.getCombo("SELECT distinct ch.State,ch.District as val, cd.dataid as ke FROM cropsdetails ch,cropdataset cd where ch.State like 'Maharashtra' and ch.District = cd.name")%>
									</select>
								</div>
							</div>
							<div class="form-group row">
